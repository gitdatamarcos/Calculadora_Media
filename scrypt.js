...
div.style.backgroundColor = `rgb(155, 155, 155)`
div.style.borderRadius = `30px`
body.appendChild(div)


const texto = document.createElement('h1')
texto.textContent = `Calculadora de Média`
...
btn.addEventListener('click', function calcnota() {
    ...
    if (media >= 7) {
        passou.textContent = `você está aprovado`
        passou.style.color = `green`
    }

    else{
        passou.textContent = `você foi reprovado`
